          ...
          <nav className="mt-5">
            <Link
              ...
              className={`flex items-center px-6 py-3 text-gray-100 hover:bg-gray-700 ${
                pathname === '/pages/admin/blog' ? 'bg-gray-700' : ''
              }`}
            >
            ...
            <Link
              ...
              className={`flex items-center px-6 py-3 text-gray-100 hover:bg-gray-700 ${
                pathname === '/pages/admin/Course' ? 'bg-gray-700' : ''
              }`}
            >
            ...
            <Link
              ...
              className={`flex items-center px-6 py-3 text-gray-100 hover:bg-gray-700 ${
                pathname === '/pages/admin/subscribers' ? 'bg-gray-700' : ''
              }`}
            >
            ...
            <button
              ...
              className="w-full flex items-center px-6 py-3 text-gray-100 hover:bg-gray-700"
            >
              <span>Logout</span>
            </button>
          </nav>
